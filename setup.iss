...
#define MyAppName "Language Generator"
#define MyAppVersion "0.0.0.1"
#define MyAppPublisher "Fi0x"
#define MyAppURL "https://github.com/Fi0x/LanguageGenerator"
#define MyAppExeName "LanguageGenerator.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{40CA25AE-255B-4A2F-AB20-9266F1D0BA7A}
AppName={#MyAppName}
...
OutputBaseFilename=languageGeneratorSetup
SetupIconFile=src\main\resources\images\ico.ico
Compression=lzma
